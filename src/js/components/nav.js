...
export function renderNav(activeView) {
  ...
  navEl.innerHTML = `
    ...
    <button id="nav-btn-add" class="w-12 h-12 rounded-full bg-accent-purple text-text-primary flex items-center justify-center shadow-lg shadow-accent-purple/30 transform active:scale-95 transition-all -mt-5 border-4 border-base">
      <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
